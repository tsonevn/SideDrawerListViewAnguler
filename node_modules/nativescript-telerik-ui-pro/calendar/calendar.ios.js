...
var RadCalendar = (function (_super) {
    ...
    RadCalendar.prototype.onDisplayedDateChanged = function (data) {
        if (data.newValue) {
            this.ios.displayedDate = data.newValue;
        }
    };
    ...
    RadCalendar.prototype.onEventsViewModeChanged = function (data) {
        ...
        switch (eventsViewMode) {
            ...
            case commonModule.CalendarEventsViewMode.Inline.toLowerCase():
                ...
                this.ios.presenter.delegate = TKCalendarMonthPresenterDelegateImplementation.alloc().initWithOwner(this);
                break;
    ...
    RadCalendar.prototype.onEventSourceChanged = function (data) {
        var newSource = data.newValue;
        if (newSource) {
            if (!this._dataSource) {
                this._dataSource = CalendarNativeDataSourceImplementation.alloc().initWithSourceAndOwner(newSource, this);
                this._ios.dataSource = this._dataSource;
            }
            else {
                this._dataSource.itemsSource = newSource;
            }
        }
    };
