...
var RadLegendView = (function (_super) {
    ...
    RadLegendView.positionProperty = new dependencyObservable.Property("position", "RadLegendView", new proxy_1.PropertyMetadata(ChartLegendPosition.Bottom, dependencyObservable.PropertyMetadataSettings.AffectsLayout, RadLegendView.onPositionPropertyChanged));
    RadLegendView.offsetOriginProperty = new dependencyObservable.Property("offsetOrigin", "RadLegendView", new proxy_1.PropertyMetadata(ChartLegendOffsetOrigin.TopLeft, dependencyObservable.PropertyMetadataSettings.AffectsLayout, RadLegendView.onOffsetOriginPropertyChanged));
        ...
        if (this.series) {
            for (var i = 0; i < this.series.length; i++) {
                ...
                if (this.series[i].horizontalAxis) {
                    this.series[i].horizontalAxis.bindingContext = newValue;
                    ;
                }
                if (this.series[i].verticalAxis) {
                    this.series[i].verticalAxis.bindingContext = newValue;
                    ;
                }
            }
        }
...
var ChartSeries = (function (_super) {
    ...
    ChartSeries.selectionModeProperty = new dependencyObservable.Property("selectionMode", "ChartSeries", new proxy_1.PropertyMetadata(false, dependencyObservable.PropertyMetadataSettings.None, ChartSeries.onSelectionModePropertyChanged));
...
var CategoricalSeries = (function (_super) {
    ...
    CategoricalSeries.categoryPropertyProperty = new dependencyObservable.Property("categoryProperty", "CategoricalSeries", new proxy_1.PropertyMetadata(undefined, dependencyObservable.PropertyMetadataSettings.AffectsLayout, CategoricalSeries.onCategoryPropertyPropertyChanged));
...
var Palette = (function (_super) {
    ...
    Palette.entriesProperty = new dependencyObservable.Property("entries", "Palette", new proxy_1.PropertyMetadata(undefined, undefined, undefined));
    Palette.seriesNameProperty = new dependencyObservable.Property("seriesName", "Palette", new proxy_1.PropertyMetadata(undefined, undefined, undefined));
    Palette.seriesStateProperty = new dependencyObservable.Property("seriesState", "PaletteEntry", new proxy_1.PropertyMetadata(undefined, undefined, undefined));
    return Palette;
}(bindable_1.Bindable));
...
var Trackball = (function (_super) {
    ...
    Trackball.snapModeProperty = new dependencyObservable.Property("snapMode", "Trackball", new proxy_1.PropertyMetadata(TrackballSnapMode.ClosestPoint, dependencyObservable.PropertyMetadataSettings.None, Trackball.onSnapModePropertyChanged));
