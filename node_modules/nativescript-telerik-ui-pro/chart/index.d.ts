...
declare class RadChartBase extends View{
    ...
    */
    public static legendProperty: Property;

    /**
    * Identifies the {@link palette} dependency property.
    */
    public static paletteProperty: Property;

    /**
    * Identifies the series dependency property.
    */
    public static seriesProperty: Property;

    /**
     * Identifies the selectionMode dependency property.
     */
    public static selectionModeProperty: Property;
...
declare module SeriesSelectionMode {
    ...
    export var Series;   
    /**
     * The touched data point wil be selected only.
     */
    export var DataPoint;
}

/**
 * Selection modes for chart and series
 */
declare module ChartSelectionMode {
    /**
...
*/
declare class RadLegendView {

    /**
    * Identifies the position dependency property.
    */
    public static positionProperty: Property;

    /**
    * Identifies the offsetOrigin dependency property.
    */
    public static offsetOriginProperty: Property;

    /**
    * Identifies the horizontalOffset dependency property.
    */
    public static horizontalOffsetProperty: Property;

    /**
    * Identifies the verticalOffset dependency property.
    */
    public static verticalOffsetProperty: Property;
...
*/
declare class Trackball extends Bindable {

    /**
    * Identifies the snap mode of the trackball.
    */
    static snapModeProperty: Property;
    ...
    */
     ...
     */
    static showIntersectionPointsProperty: Property;
...
declare class CartesianAxis extends Bindable {
    ...
    */
    public static lineThicknessProperty: Property;

    /**
    * Identifies the lineHidden dependency property.
    */
    public static lineHiddenProperty: Property;

    /**
    * Identifies the allowPan dependency property.
    */
    public static allowPanProperty: Property;

    /**
    * Identifies the allowZoom dependency property.
    */
    public static allowZoomProperty: Property;
        
    /**
    * Identifies the hidden dependency property.
    */
    public static hiddenProperty: Property;
    ...
    /**
    * Gets or sets the horizontal location of the axis. Use values expored from {@link AxisHorizontalLocation}.
    */
    ...
    */
    ...
    /**
     * Gets or sets the fit mode for axis labels. Use expored values from {@link AxisLabelFitMode}.
     */
    labelFitMode: string;

    /**
     * Gets or sets the layout mode for axis labels. Use expored values from {@link AxisLabelLayoutMode}.
     */
...
declare module AxisLabelLayoutMode {
    ...
    var Outer: string;
    /*
     * The labels will be inside of the chart. Otherwise said, for horizontal axis thelabel will be on top and for vertical on left side of axis. 
     */
    var Inner: string;
}
...
declare class LinearAxis extends CartesianAxis {
    ...
    */
    public static minimumProperty: Property;

    /**
    * Identifies the maximum dependency property.
    */
    public static maximumProperty: Property;

    /**
    * Identifies the majorStep dependency property.
    */
    public static majorStepProperty: Property;
...
declare class CategoricalAxis extends CartesianAxis {
    ...
    */
    public static plotModeProperty: Property;
    
    /**
    * Identifies the majorTickInterval dependency property.
    */
    public static majorTickIntervalProperty: Property;
...
declare class DateTimeCategoricalAxis extends CategoricalAxis {
    ...
    */
    public static dateTimeComponentProperty: Property;

    /**
    * Identifies the dateFormat dependency property.
    */
    public static dateFormatProperty: Property;
...
* The majorStep proeprty should use values exported from module {@link DateTimeComponent}.
*/
...
declare class LogarithmicAxis extends LinearAxis {
    ...
    */
    public static exponentStepProperty: Property;

    /**
    * Identifies the {@link logarithmBase} dependency property.
    */
    public static logarithmBaseProperty: Property;
...
*/
declare class ChartSeries extends Bindable {
    /**
    ...
    */
    public static valueProperty: Property;

    /**
    * Identifies the {@link legendTitle} dependency property.
    */
    public static legendTitleProperty: Property;
     ...
     */
    public static labelStyleProperty: Property;
    
    /**
     * Identifies the showLabels dependency property.
     */
    public static showLabelsProperty: Property;
...
declare class OhlcSeries extends CartesianSeries {
    ...
    */
    public static openPropertyNameProperty: Property;

    /**
    * Identifies the {@link closePropertyName} dependency property.
    */
    public static closePropertyNameProperty: Property;

    /**
    * Identifies the {@link highPropertyName} dependency property.
    */
    public static highPropertyNameProperty: Property;

    /**
    * Identifies the {@link lowPropertyName} dependency property.
    */
    public static lowPropertyNameProperty: Property;
...
declare class CategoricalSeries extends CartesianSeries {
    ...
    */
    public static categoryPropertyProperty: Property;

    /**
    * Identifies the stackMode dependency property.
    */
    public static stackModeProperty: Property;
...
declare class PieSeries extends ChartSeries {
    ...
    */
     ...
     */
    public static expandRadiusProperty: Property;
     
    /**
     * Identifies the outerRadius dependency property.
     */
    public static outerRadiusFactorProperty: Property;   
        
    /**
     * Identifies the startAngle dependency property.
     */
    public static startAngleProperty: Property;
        
    /**
     * Identifies the endAngle dependency property.
     */
    public static endAngleProperty: Property;
        
    /**
     * Identifies the legendLabel dependency property.
     */
    public static legendLabelProperty: Property;
...
declare class DonutSeries extends PieSeries {
    ...
    */
     ...
     */
    public static innerRadiusFactorProperty: Property;
...
/**
* Defines series that represent the data as points using two dimentional values (x,y) for horizontal and vertical axes respectively.
...
declare class ScatterSeries extends CartesianSeries {
    ...
    */
    public static xPropertyProperty: Property;
    
    /**
    * Identifies the {@link yProperty} dependency property.
    */
    public static yPropertyProperty: Property;
...
/**
* Represents a scatter bubble series. ScatterBubbleSeries like all other scatter series require two numerical axes to function propely.
...
declare class ScatterBubbleSeries extends ScatterSeries {
    ...
    */
    public static bubbleScaleProperty: Property;

    /**
    * Identifies the {@link bubbleSizePropertyName} dependency property.
    */
    public static bubbleSizePropertyNameProperty: Property;
...
declare class BubbleSeries extends CategoricalSeries {
    ...
    * Identifies the {@link bubbleSizePropertyName} dependency property.
    */
    public static bubbleSizePropertyProperty: Property;
...
declare class PaletteEntry {
    ...
    */
    public static strokeWidth: Property;
...
*/
declare class CartesianChartAnnotation extends Bindable {
    /**
    * Identifies the axisID dependency property.
    */
    public static axisIdProperty: Property;

    /**
    * Identifies the zPosition dependency property.
    */
    public static zPositionProperty: Property;
    ...
    * Identifies the strokeWidth dependency property.
    */
    public static strokeWidthProperty: Property;
    ...
    */
    public static strokeDashPatternProperty: Property;
...
declare class ChartPlotBandAnnotation extends CartesianChartAnnotation {
    ...
    */
    public static minValueProperty: Property;

    /**
    * Identifies the maxValue dependency property.
    */
    public static maxValueProperty: Property;
...
declare class PointLabelStyle extends Bindable {
    ...
    */
    public static textSizeProperty: Property;

    /**
    * Identifies the margin dependency property.
    */
    public static marginProperty: Property;

    /**
    * Identifies the textFormat dependency property.
    */
    public static textFormatProperty: Property;

    /**
    * Identifies the fontName dependency property.
    */
    public static fontNameProperty: Property;

    /**
    * Identifies the fontStyle dependency property.
    */
    public static fontStyleProperty: Property;
