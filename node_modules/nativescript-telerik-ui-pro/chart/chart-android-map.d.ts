            ...
            module chart {
                module engine {
                    ...
                    module axes {
                        module common {
                            ...
                            enum TimeInterval {    YEAR,   QUARTER,    MONTH,    WEEK,    WEEK_OF_YEAR,    DAY,    DAY_OF_WEEK,
                                                    DAY_OF_WEEK_IN_MONTH,    DAY_OF_YEAR,    HOUR,    MINUTE,    SECOND,    MILLISECOND,    TIME_IN_MILLIS
                                                }
                        }
                        enum AxisLabelLayoutMode { OUTER, INNER }
                    }
                ...
                module visualization {
                    module behaviors {
                        ...
                        class ChartPopupBehavior extends ChartBehavior {
                        ...
                        class ChartTrackBallBehavior extends ChartPopupBehavior {
                            public getSnapMode(): TrackBallSnapMode;
                            public setSnapMode(mode: TrackBallSnapMode);
                        }
                    ...
                    module common {
                        ...
                        class CartesianAxis {
                            ...
                            setDateTimeFormat(format: DateFormat);
                    ...
                    module cartesianChart {
                        ...
                        module axes {
                            ...
                            class DateTimeContinuousAxis extends LinearAxis {
                                constructor();
                                setMajorStepUnit(value: com.telerik.widget.chart.engine.axes.common.TimeInterval);
                            }
                        }
                        ...
                        module series {
                            ...
                            module categorical {
                                ...
                                class RangeBarSeries extends CategoricalSeries {
                                    constructor();
                                }
                        ...
                        class CartesianChartGrid {
                            ...
                            setVerticalLineColor(value: any);
                            setLineThickness(value: any);
                            setVerticalLineThickness(value: any);
                        ...
                        class RadCartesianChartView extends android.view.View {
                            ...
                            getPalette(): any;
                            getSelectionPalette(): any;
                            setSelectionPalette(value: any)
                            setHorizontalAxis(value: com.telerik.widget.chart.visualization.common.CartesianAxis);
                            setVerticalAxis(value: com.telerik.widget.chart.visualization.common.CartesianAxis);
