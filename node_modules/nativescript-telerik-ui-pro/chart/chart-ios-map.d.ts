...
declare class TKChartGridStyle {
    ...
    public drawOrder: TKChartGridDrawMode;
}
...
declare class TKChartAxis {
    ...
    public labelFormatter : NSFormatter;
...
declare class TKChartDateTimeAxis extends TKChartAxis {
    ...
    public setPlotMode(plotMode : TKChartAxisPlotMode);
}
...
declare class TKChartDateTimeCategoryAxis extends TKChartAxis {
    ...
    public majorTickIntervalUnit: TKChartDateTimeAxisIntervalUnit;
    public minorTickIntervalUnit: TKChartDateTimeAxisIntervalUnit;
    public dateComponent: NSCalendarUnit;
    public range: TKRange;
}
...
declare class TKChartRangeDataPoint{
    static new();
    static alloc();
    public dataXValue: any;
    public dataYValue: any;
    public low: any;
    public high : any;
    public initWithXLowHigh(xValue: any, lowValue: any, highValue: any) : TKChartRangeDataPoint;
    public initWithYLowHigh(yValue: any, lowValue: any,highValue: any) : TKChartRangeDataPoint;
}
...
declare enum TKChartGridDrawMode {
...
declare enum TKChartLegendOffsetOrigin{
...
declare enum TKChartAxisLabelAlignment {
    /**
